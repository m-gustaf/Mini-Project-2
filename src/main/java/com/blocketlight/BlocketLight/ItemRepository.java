...
public class ItemRepository {
    ...
    public ItemRepository() {
        ...
        items.add(new Item(6, Category.ROAD_BIKE, "Cannondale Supersix EVO", 2021, 69900, true,"https://www.google.com/search?q=cannondale+supersix&rlz=1C1GCEU_enSE916SE916&source=lnms&tbm=isch&sa=X&ved=2ahUKEwjBqdG4z7nvAhWOtYsKHZFsCHcQ_AUoAXoECAYQAw&biw=1920&bih=937#imgrc=y_eu3NE46yJeMM"));
    }
